...
##Creat dictionary of 50 states in four regions in USA
...
##import csv file from local path file name "american crime estimation 1979 to 2019"
USA_crime = pd.read_csv("C:\\Users\\Home\\Desktop\\estimated_crimes_1979_2019.csv")

##checking infomation and structure of the dataframe
...
##insight 5
##show crime rate of each type of crime from each region 1979 to 2019
